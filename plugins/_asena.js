...
if (Config.WORKTYPE == 'private') {
    ...
    QueenSew.newcmdaddtosew({pattern: 'SEW ?(.*)', fromSew: true, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
...
/*slf*/
QueenSew.newcmdaddtosew({pattern: 'phelp ?(.*)', fromSew: true, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        QueenSew.commands.map(
            async (command) =>  {
 ...
 +CMD_HELP + '\n\n┈┈╭━╱▔▔▔▔╲━╮┈┈┈ꜱ\n┈┈╰╱╭▅╮╭▅╮╲╯┈┈┈ᴇ\n╳┈┈▏╰┈▅▅┈╯▕┈┈┈┈ᴡ\n┈┈┈╲┈╰━━╯┈╱┈┈╳┈ǫ\n┈┈┈╱╱▔╲╱▔╲╲┈┈┈┈ᴜ\n┈╭━╮▔▏┊┊▕▔╭━╮┈╳ᴇ\n┈┃┊┣▔╲┊┊╱▔┫┊┃┈┈ᴇ\n┈╰━━━━╲╱━━━━╯┈╳ɴ\n  ᴾᵒʷᵉʳᵈ ᴮʸ ˢᵉʷ Qᵘᵉᵉⁿ\n\n_*Coded By Ravindu Manoj*_ ', MessageType.text,{quoted: message.data}
    ...
    QueenSew.newcmdaddtosew({pattern: 'SEW ?(.*)', fromSew: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        QueenSew.commands.map(
            async (command) =>  {
...
/*slf*/
QueenSew.newcmdaddtosew({pattern: 'phelp ?(.*)', fromSew: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        QueenSew.commands.map(
            async (command) =>  {
