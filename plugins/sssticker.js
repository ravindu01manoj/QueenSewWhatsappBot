...
if (Config.WORKTYPE == 'private') {
    QueenSew.newcmdaddtosew({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    QueenSew.newcmdaddtosew({pattern: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    QueenSew.newcmdaddtosew({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC, dontAdCommandList: true}, (async (message, match) => {    
