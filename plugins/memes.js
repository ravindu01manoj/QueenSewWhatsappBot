...
if (Config.WORKTYPE == 'private') {
    ...
    QueenSew.newcmdaddtosew({pattern: 'meme ?(.*)', fromSew: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
	    ...
	    memeMaker({
            ...
            await message.client.sendMessage(message.jid, fs.readFileSync('asena-meme.png'), MessageType.image, {filename: 'asena-meme.png', mimetype: Mimetype.png, caption: '*Coded By t.me/RavinduManoj*'});
            await info.delete();    
        });
    }));
}
