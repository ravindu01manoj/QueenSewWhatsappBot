...
const ravindumanoj = require('textmaker-sew'); // Import NPM Package
...
QueenSew.newcmdaddtosew({pattern: 'sewmaker$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    var t1 = ''
    var t2 = ''
    var t3 = ''
    var t4 = ''
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/devil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/devil.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/bear.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/bear.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/wolf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/wolf.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon2.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/li.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/joker.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/joker.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sewninja ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-ninja-logo-online-935.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ninja.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ninja.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tt.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tt.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/bkh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/bkh.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sewmarvel ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-logo-style-marvel-studios-online-971.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/marvel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/marvel.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sew2marvel ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/mar2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/mar2.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/aven.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/aven.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sewglitch ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tt2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tt2.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sewgraf ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-cool-wall-graffiti-text-effect-online-1009.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ttgra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ttgra.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sew2graf ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t2gra.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sewlion ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-lion-logo-mascot-online-938.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/lion.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/lion.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon3.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon3.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ice.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ice.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'space ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    ravindumanoj.textpro("https://textpro.me/create-space-3d-text-effect-online-985.html",
        [`${topText}`, `${bottomText}`]
        ).then(async (data) => { 
          try { 
              var download = async(uri, filename, callback) => {
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/space.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/space.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/smoke.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/smoke.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
QueenSew.newcmdaddtosew({pattern: 'sewglow ?(.*)', fromMe: wk, dontAdCommandList: true}, (async (message, match) => {
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/WhatsAsenaDuplicated/glowttp.jpg', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/glowttp.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
    })
}));
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tfire.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tfire.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/hp.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/hp.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t4n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t4n.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/cmth.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/cmth.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/cup.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/cup.jpg'), MessageType.image, { caption: '*Made By t.me/RavinduManoj*' })
              })
          } catch(err) { 
              console.log(err)
          } 
