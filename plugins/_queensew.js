...
/*slf*/
QueenSew.newcmdaddtosew({pattern: 'phelp ?(.*)', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        QueenSew.commands.map(
            async (command) =>  {
...
/*slf*/
QueenSew.newcmdaddtosew({pattern: 'phelp ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        QueenSew.commands.map(
            async (command) =>  {
